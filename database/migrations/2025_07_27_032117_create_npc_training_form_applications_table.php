...
return new class extends Migration
{
    ...
    {
        Schema::create('npc_training_form_applications', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('npc_training_form_id')->nullable();
            $table->foreign('npc_training_form_id')->references('id')->on('npc_training_forms')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('npc_training_form_applications');
    }
};
