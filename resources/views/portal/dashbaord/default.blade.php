                                            ...
                                            <table class="table table-bordernone">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <img class="max-w-full h-auto img-40 rounded-full me-2"
                                                                src="../assets/images/dashboard/user/9.jpg"
                                                                alt="user" />
                                                        </td>
                                                        <td class="img-content-box">
                                        ...
                                        <div class="card-header-right-icon">
                                            <div class="dropdown icon-dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end"
                                                    aria-labelledby="orderThisMonth">
                                            ...
                                            <div class="dropdown icon-dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end"
                                                    ...
                                                    <a class="dropdown-item" href="#">Today</a><a
                                                        ...
                                                        class="dropdown-item" href="#">Previous Month</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body pt-0">
                                    <div class="recent-sliders tabs">
                                        <div class="tab-links recent-order-scroll custom-scrollbar flex gap-2">
                                            <a class="tab tab-link active frame-box" href="#!"
                                                data-tabFilter="1"><span data-bs-toggle="tooltip"
                                                    data-bs-placement="bottom" data-tooltip="Furniture">
                                            ...
                                            <td>
                                                <div class="common-flex items-center">
                                                    <img class="max-w-full h-auto rounded-full"
                                                        ...
                                                        alt="user" /><a class="font-medium"
                                                        href="list-products.html">E2 Watch</a>
                                                </div>
                                            </td>
                                            <td>Electronics</td>
                                            <td>3,851</td>
